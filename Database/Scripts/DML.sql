DROP FROM phone;
DROP FROM delivery_radius;
DROP FROM ordered_item;
DROP FROM item;
DROP FROM orders;
DROP FROM transaction;
DROP FROM rider;
DROP FROM credit_card;
DROP FROM vendor;
DROP FROM consumer;
...
INSERT INTO consumer(ID, first_name, middle_name, last_name, city, area, street_num, building_num, phone_num, wallet, email_id, gender) VALUES (NULL, "Hamza", NULL, "Rafi", "Quetta", "Defense", 111, 1, "03234565811", 142, "hamzarafi@gmail.com", "Other");
...
INSERT INTO consumer(ID, first_name, middle_name, last_name, city, area, street_num, building_num, phone_num, wallet, email_id, gender) VALUES (NULL, "Abdullah", NULL, "Ijaz", "Sialkot", "Defense", 511, 112, "03234564411", 11, "abdullahijz@gmail.com", "Male");

INSERT INTO rider VALUES(1, "Mutahar", NULL, "Ali", "Lahore", "Gulberg", 3, 14, "Car", "LE-8080", "03004958800", "Male", "PK86UBLT5050358099703523", NULL);
INSERT INTO rider VALUES(NULL, "Faizan", NULL, "Elahi", "Lahore", "Defence", 20, 15, "Motorcycle", "A420", "03008976543", "Male", "PK86JSLT5050358096303523", NULL);
INSERT INTO rider VALUES(NULL, "Muhammad", "Bilal", "Shahid", "Lahore", "Model Town", 5, 420, "Bicycle", "LQ-69", "03314950730", "Other", "PK89HBLT5050358099709876", NULL);
INSERT INTO rider VALUES(NULL, "Samee", NULL, "Arif", "Karachi", "Sea view", 3, 24, "Car", "LE-7171", "03244957700", "Male", "PK71UBLT5050058099693523", NULL);
INSERT INTO rider VALUES(NULL, "Mustafa", NULL, "Sidiqui", "Faislabad", "Defence", 8, 34, "Motorcycle", "LEF-8197", "03004958800", "Male", "PK51FSBL5050358099703523", NULL);
INSERT INTO rider VALUES(NULL, "Hafsa", NULL, "Khan", "Islamabad", "Defence", 15, 8, "Car", "LEA-8097", "03518875963", "Female", "PK11SKLE5050357799703523", NULL);
...
INSERT INTO phone(phone_num, ID) VALUES (1, "03326677133");
INSERT INTO phone(phone_num, ID) VALUES (2, "03322217133");
INSERT INTO phone(phone_num, ID) VALUES (3, "03326611533");
INSERT INTO phone(phone_num, ID) VALUES (4, "02521677133");
INSERT INTO phone(phone_num, ID) VALUES (5, "03112377133");

INSERT INTO delivery_radius(ID, city, area) VALUES (1, "Lahore", "Defense");
...
INSERT INTO delivery_radius(ID, city, area) VALUES (4, "Quetta", "Defense");
...
INSERT INTO transaction(ID, orders_ID, payment_method, credit_card_num) VALUES (NULL, 2, "Cash", 123451711123);
...
INSERT INTO transaction(ID, orders_ID, payment_method, credit_card_num) VALUES (NULL, 5, "Cash", 123427666623);
