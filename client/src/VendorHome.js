...
const VendorHome = () => {
    ...
    const viewOrderHistory = async (ev) => {
        ev.preventDefault();
        try{
            const res = await axios.get('https://foodswings.herokuapp.com/vendor/orderHistory', {withCredentials: true});
    ...
    const viewActiveOrders = async (ev) => {
        ...
        try{
            ...
            if (res.data.orders.length === 0){
                ...
                navigate('/vendor/activeOrders', {state: {
                    orders: res.data.orders
                }})
            }
        }
    ...
    return (  
        <div>
            <h2 className="display-6 text-white bg-primary text-center fw-bold py-1">Vendor Home page</h2>
            ...
            <div className="text-center" style={{"display":"flex", "alignItems":"center", "justifyContent":"center"}}>
                <div className="ms-2 me-2" style={{"width":"50rem"}}>
                    <div className="card" >
                        <h5 className="card-header">View and update menu</h5>
                        <div className="card-body">
                            <p className="card-text">Add and remove items to your menu to keep your customers up to date with exciting new flavors!</p>
                            <button className="btn btn-lg btn-danger" onClick={updateMenu}>Go to menu</button>
                        </div>
                    </div>
                    <br />
                    <div className="card" >
                        ...
                        <div className="card-body">
                            ...
                            <button className="btn btn-lg btn-danger" onClick={viewActiveOrders} >View active orders</button>
                        </div>
                    </div>
                    <br />
                    <div className="card" >
